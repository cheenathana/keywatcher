#ifndef KEYMAPPER_HEADER
#define KEYMAPPER_HEADER

#include <string>
#include <map>

class KeyMap {
  /* Mapping the keystroke's system code with the readable key type */
  private:
    std::string system_name;     // Not a user friendly name kinda code name
    std::string key_name;         // Name denoting the keyboard key and written to file
...
// KEY_HEXVALUE, {"SYSTEM_KEY_NAME:, "ACTUAL_KEY_NAME"}
std::map<int, KeyMap> KEYS = {
